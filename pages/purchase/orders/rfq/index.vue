  ...
  <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
    <nav aria-label="breadcrumb" class="w-max">
            <ol class="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
                ...
                <li
                    class="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                    <nuxt-link to="/purchase/orders/rfq">
                        <p class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">
                            Requests For Quotation</p>
                    </nuxt-link>
                </li>
            </ol>
        </nav>
    ...
    <div
      ...
      <div class="flex justify-between">
        ...
        <div class="w-60 flex justify-end space-x-2">
          <nuxt-link to="/purchase/orders/rfq/newrfq"
            class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Request
            New Quotation</nuxt-link>
        </div>
      </div>
    </div>
        ...
        <table class="min-w-full">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                Deadline</th>
              <!-- <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">Status
                <span :class="{ 'text-green-900': company.is_approved, 'text-red-900': !company.is_approved }"
                  class="relative inline-block px-3 py-1 font-semibold leading-tight">
                  <span aria-hidden class="absolute inset-0 opacity-50 rounded-full"
                    :class="{ 'bg-green-200': company.is_approved, 'bg-red-200': !company.is_approved }"></span>

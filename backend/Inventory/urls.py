...
urlpatterns = [
    ...
    path('UoM/get/', UnitOfMeasureCategoryViewSet.as_view({'post': 'get_unit_of_measure_categories'}), name='get-UoM'),
    ...
    path('rrv/get/', ReorderingRuleViewSet.as_view({'post': 'get_reordering_rules'}), name='get-rrv'),
    path('rrv/update/<pk>/', ReorderingRuleViewSet.as_view({'put': 'update_reordering_rule'}), name='update-rrv'),
    path('rrv/delete/<pk>/', ReorderingRuleViewSet.as_view({'delete': 'delete_reordering_rule'}), name='delete-rrv'),
    path('bcn/create/', BarcodeNomenclatureViewSet.as_view({'post': 'create_barcode_nomenclature'}), name='create-bcn'),
    path('bcn/get/', BarcodeNomenclatureViewSet.as_view({'post': 'get_barcode_nomenclatures'}), name='get-bcn'),
    path('bcn/update/<pk>/', BarcodeNomenclatureViewSet.as_view({'put': 'update_barcode_nomenclature'}), name='update-bcn'),
    path('bcn/delete/<pk>/', BarcodeNomenclatureViewSet.as_view({'delete': 'delete_barcode_nomenclature'}), name='delete-bcn'),
]